...
var Module = (function () {
  ...
  define('errors.ErrorMessage', function (module, exports) {
    var ErrorMessage = {};
  ...
  define('events.Event', function (module, exports) {
  ...
  define('events.EventEmitter', function (module, exports) {
  ...
  define('events.EventPhase', function (module, exports) {
    var EventPhase = {
      CAPTURING_PHASE: 1,
      AT_TARGET      : 2,
      BUBBLING_PHASE : 3
  ...
  define('geom.Matrix', function (module, exports) {
  ...
  define('geom.Point', function (module, exports) {
  ...
  define('geom.Rectangle', function (module, exports) {
    var Matrix = require('geom.Matrix')
      , min = Math.min
      , max = Math.max
      , floor = Math.floor
  ...
  define('net.url', function (module, exports) {
  ...
  define('serializer.querystring', function (module, exports) {
  ...
  define('timers.Ticker', function (module, exports) {
  ...
  define('utils.array', function (module, exports) {
